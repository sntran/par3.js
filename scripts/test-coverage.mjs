...
const trackedFiles = ["_worker.js", "bin/main.js", "lib/mod.js"];
const testFiles = ["_worker_test.js", "bin/main_test.js", "lib/mod_test.js"];
...
function parseCoverage(output) {
  ...
  for (const rawLine of stripAnsi(output).split(/\r?\n/u)) {
    ...
    if (fileColumn && !linePercent && !branchPercent && !functionPercent) {
...
console.log("Coverage thresholds met for _worker.js, bin/main.js, and lib/mod.js.");
